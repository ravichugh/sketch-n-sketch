...
dummyExp msg row col row2 col2 = Expr <| WithInfo (Exp_ (EBase space0 <| EString "\"" msg) 0) (Pos row col) (Pos row2 col2)

dummyExp1: String -> Int -> Int -> Int -> Int -> Exp
dummyExp1 msg row col row2 col2 = Expr <| WithInfo (Exp_ (EBase space0 <| EString "\"" msg) 0) (Pos (row - 1) (col - 1)) (Pos (row2 - 1) (col2 - 1))
