...
emptyTree = Utils.fromOk "LangSvg.emptyTree" <| valToIndexedTree <| vList [vBase (VString "svg"), vList [], vList []]
...
printIndexedTree = valToIndexedTree >> Utils.fromOk "LangSvg.printIndexedTree" >> snd >> strEdges
