...
list sub e = case (unwrapExp e) of
  ...
  _ -> Err <| "Expected a list, got " ++ Syntax.unparser Syntax.Leo e
...
viewtuple2 sub1 sub2 e = case (unwrapExp e) of
  ...
  _ -> Err <| "Expected a 2-element list, got " ++ Syntax.unparser Syntax.Leo e

string: Exp -> Result String String
string e = case (unwrapExp e) of
  EBase _ (EString _ s) -> Ok s
  _ -> Err <| "Expected a string, got " ++ Syntax.unparser Syntax.Leo e

int: Exp -> Result String Int
int e = case (unwrapExp e) of
  EConst _ n _ _ -> Ok (floor n)
  _ -> Err <| "Expected a constant, got " ++ Syntax.unparser Syntax.Leo e
