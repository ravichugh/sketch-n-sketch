...
{- TODO maybe delete
wsAfter : CodeObject -> Maybe WS
wsAfter co =
  case co of
    E e ->
      case (unwrapExp e) of
        EFun _ _ _ wsa ->          Just wsa
        EApp _ _ _ _ wsa ->        Just wsa
        EOp _ _ _ _ wsa ->         Just wsa
        EList _ _ _ m ws3 ->       Maybe.map (always ws3) m
        EIf _ _ _ _ _ _ wsa ->     Just wsa
        ELet _ _ _ _ (Expr e2) ->  Just <| withInfo "" e2.end e2.end
        _ ->                       Nothing
    P e p ->
      case p.val.p__ of
        PList _ _ _ m ws3 ->       Maybe.map (always ws3) m)
        _ ->                       Nothing
    T t ->
      case t.val of
        TNum ws1 ->
