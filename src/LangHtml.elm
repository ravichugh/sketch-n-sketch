...
addAttr pseudosel (key, val) attrsdict = case Dict.get pseudosel attrsdict of
    Just attrs -> Dict.insert pseudosel (attrs ++ " " ++ key ++ ": " ++
                                            strAVal val ++ ";") attrsdict
    Nothing -> Dict.insert pseudosel (key ++ ": " ++ strAVal val ++ ";")
                                     attrsdict

classStr : Int -> (String, String) -> String
classStr k (pseudosel, attrstr) =
