...
Although this does, in fact, draw three evenly-spaced rectangles, the copy-and-
pasted code makes it difficult to change the overall program. What if we wanted
to change a single property of the pattern, such as the color of the boxes or
the separation between them? As structured, our only option would be to make the
...
**Practice 1.1:** Go ahead and map your placement function over a list of
...
**Practice 1.2:** Different shapes come with different attributes that can be manipulated.
...
<iframe
   ...
   width="980" height="840" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
