...
- Change your placement function to take an x- and a y-position and use these to
  make a grid of shapes. Hint: The function can be mapped over a list of the
...
Continue on to [Step 2][step2]. TODO: Link
...
[step2]: http://ravichugh.github.io/sketch-n-sketch/tutorial/02.html
