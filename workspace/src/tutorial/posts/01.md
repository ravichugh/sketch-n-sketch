...
[Sketch-n-Sketch v0.4.1][sns] open in a separate tab or window and try out all
...
<img align="right" width="450px" style="padding: 0 20px 0 20px;"
     src="__ROOT__/static/images/tutorial/01/sketch-n-sketch.png"/>
...
<!--
Similarly, the [Code Box] buttons toggles between a "fancy" code pane
...
<img align="right" width="350px" style="padding: 0 0px 0 20px;"
     src="__ROOT__/static/images/tutorial/01/three-boxes.png"/>
...
<img align="right" width="350px" style="padding: 0 0px 0 20px;"
     src="__ROOT__/static/images/tutorial/01/grid-boxes.png"/>
...
[sns]: http://ravichugh.github.io/sketch-n-sketch/releases/v0.4.1/
