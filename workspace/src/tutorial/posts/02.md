...
(def [deltaP deltaS] [10! 20!])
(def groupBox
   (rect [255 255 255 0] (- x0 deltaP) (- y0 deltaP) (+ w deltaS) (+ h deltaS)))
```
...
in the built-in examples US-13 Flag and US-50 Flag.
...
that consists mostly of simple shapes for now. One enjoyable option may be to
