...
one straight line in your design, but you can keep it fairly simple for now. For
example, continuing with our alphabaetic quest, select a letter that has some
symmetry to it - such as 'S' or 'B'.
...
1. Pick a design that would be difficult or impossible to create using only basic
    ...
    contiguous edges is a good candidate. One option would be to choose an
    existing logo design of a favorite organization of your's or your place of work.
    Many can be found either with a simple online search or by looking around
    [here](http://www.brandsoftheworld.com/).
2. Find a subset of the design that can be expressed as a path and in terms of
    ...
    path. It is okay if it's only part of the design that can be expressed in
    this way.
...
<iframe src="https://docs.google.com/forms/d/1x_3asGDGlrVoozexLjWQdYlgwveRzr_Xbx5oCj8BlMg/viewform?embedded=true" width="760" height="1100" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
<br>
