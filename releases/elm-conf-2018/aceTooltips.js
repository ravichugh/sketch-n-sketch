// TWO FILES (tooltip.js and annot.js)
...
// Starting from:
// https://github.com/ranjitjhala/ace-annot/tree/master/js/tooltip.js
// https://github.com/UCSD-PL/impscript/blob/master/ace-output/js/tooltip.js
...
var TokenTooltip = function(editor, annotFun) {
    ...
    // ORIG event.addListener(editor.renderer.scroller, "mousemove",
    // this.onMouseMove);
    // ORIG event.addListener(editor.renderer.content, "mouseout",
    // this.onMouseOut);
};
...
(function(){
    ...
    this.update = function() {
        ...
        // ORIG var tokRange  = session.getAWordRange(docPos.row,
        // docPos.column);
        ...
        // ORIG this.range = new Range(docPos.row, token.start, docPos.row,
    ...
    this.destroy = function() {
        this.onMouseOut();
        // event.removeListener(this.editor.renderer.scroller, "mousemove",
        // this.onMouseMove);
        // event.removeListener(this.editor.renderer.content, "mouseout",
        // this.onMouseOut);
...
// Starting from:
// https://github.com/ranjitjhala/ace-annot/tree/master/js/annot.js
// https://github.com/UCSD-PL/impscript/blob/master/ace-output/js/annot.js
...
function getTooltipText(row, col) {
  var rowA = tooltipTable[row];
...
// rkc
function clearTooltips() { tooltipTable = {}; }

// rkc
function addTooltip(row, col, ann) {
  if (!tooltipTable[row]) { tooltipTable[row] = {}; }
  if (!tooltipTable[row][col]) { tooltipTable[row][col] = {}; }
  tooltipTable[row][col].ann = ann;
}
