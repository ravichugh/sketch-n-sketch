 ...
 */ Module;
if (!Module) /** @suppress{checkTypes}*/Module = typeof Module !== 'undefined' ? Module : {};
...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'reduce.oneshot.data';
      var REMOTE_PACKAGE_BASE = 'reduce.oneshot.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_reduce.oneshot.data');

      };
      Module['addRunDependency']('datafile_reduce.oneshot.data');
   ...
   loadPackage({"files": [{"filename": "/reduce.img", "start": 0, "end": 3904385, "audio": 0}], "remote_package_size": 3904385, "package_uuid": "e5c5b539-e9a1-4b05-b5ae-34df7c6b8e4f"});
...
function input_char() {
  input_started = true;
  let char_code = input_str.charCodeAt(input_i);
  input_i++;
  return (isNaN(char_code) ? null : char_code);
}

Module["preInit"] = function () {
  FS.init(input_char, null, null);
};

Module["print"] = function(line) {
  if (input_started && !output_finished && line !== "") {
    output += " " + line;

    if (line.lastIndexOf("$") === line.length - 1) {
      output = output.slice(0,-1); // Remove trailing $
...
var wasmBinaryFile = 'reduce.oneshot.wasm';
...
var FSNode = /** @constructor */ function(parent, name, mode, rdev) {
  ...
  FS.FSNode = FSNode;
  FS.staticInit();/**@suppress {duplicate, undefinedVars}*/var Browser;Module["FS_createPath"] = FS.createPath;Module["FS_createDataFile"] = FS.createDataFile;Module["FS_createPreloadedFile"] = FS.createPreloadedFile;Module["FS_createLazyFile"] = FS.createLazyFile;Module["FS_createDevice"] = FS.createDevice;Module["FS_unlink"] = FS.unlink;;
var ASSERTIONS = true;
