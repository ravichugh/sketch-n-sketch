...
When making this logo, I found that I naturally used a slider to adjust the size of the white wedge. Z ordering seems to be exceedingly important with these sorts of designs, as the use of a mask makes apparent. Providing a nice way to specify Z order will likely be a significant improvement.
